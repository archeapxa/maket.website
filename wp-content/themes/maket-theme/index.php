	...
	<body class="body">
								...
								<div class="row">
									<div class="col-12 col-md-6">
										<div class="advantages-block">
											...
											<div class="advantages-block__text">
												<?php echo the_field('advantage_1', 2);?>
											</div>
										...
										<div class="advantages-block">
											...
											<!-- /.advantages-block__img -->
											<div class="advantages-block__text">
												<?php echo the_field('advantage_2', 2);?>
											</div>
											<!-- /.advantages-block__text -->
										</div>
										<!-- /.advantages-block -->
										<div class="advantages-block">
											...
											<!-- /.advantages-block__img -->
											<div class="advantages-block__text">
												<?php echo the_field('advantage_3', 2);?>
											</div>
											<!-- /.advantages-block__text -->
										</div>
										<!-- /.advantages-block -->
									...
									<div class="col-12 col-md-6">
										<div class="advantages-block">
											...
											<!-- /.advantages-block__img -->
											<div class="advantages-block__text">
												<?php echo the_field('advantage_4', 2);?>
											</div>
											<!-- /.advantages-block__text -->
										</div>
										<!-- /.advantages-block -->
										<div class="advantages-block">
											...
											<!-- /.advantages-block__img -->
											<div class="advantages-block__text">
												<?php echo the_field('advantage_5', 2);?>
											</div>
											<!-- /.advantages-block__text -->
										</div>
										<!-- /.advantages-block -->
										<div class="advantages-block advantages-block_last">
											...
											<!-- /.advantages-block__img -->
											<div class="advantages-block__text">
												<?php echo the_field('advantage_6', 2);?>
											</div>
											<!-- /.advantages-block__text -->
										</div>
										<!-- /.advantages-block -->
						...
						<div class="col-12 col-md-10 col-lg-5 col-xl-4">
							<!-- <form action="mailer/smart.php" method="POST" class="form"> -->
								<div class="form-main form">
									...
									<?php echo do_shortcode( '[contact-form-7 id="163" title="main-form"]');?>
		...
		<section class="section-slider order">
			...
			<div class="container">
				<!-- <form action="mailer/smart.php" method="POST" class="form form-order"> -->
					<div class="form-main form-main_order form">
						...
						<!-- /.form-block -->
						<?php echo do_shortcode( '[contact-form-7 id="170" title="horizontal-form"]');?>
		...
		<div class="manual-bg">
			<section class="section-slider manual" id="manual">
				<div class="section-title manual-section-title">
					<h2>
						<?php the_field('section_header', 2)?>
					</h2>
				</div>
				<!-- /.section-title -->
				<div class="container">
					<div class="row">
						<div class="col-12 col-lg-3">
							<div class="manual-block">
								<div class="manual-block__img">
									<img src="<?php the_field('step_image_1', 2)?>" alt="">
								</div>
								<!-- /.manual-img -->
								<div class="manual-block__text">
									<?php the_field('step_text_1', 2)?>
									<div class="manual-block__text_order  show-order">
										<?php the_field('step_button_1', 2)?>
									</div>
								</div>
								<!-- /.manual-text -->
							</div>
						...
						<div class="col-12 col-lg-3">
							<div class="manual-block">
								<div class="manual-block__img">
									<img src="<?php the_field('step_image_2', 2)?>" alt="">
								</div>
								<!-- /.manual-img -->
								<div class="manual-block__text">
									<?php the_field('step_text_2', 2)?>
								</div>
								<!-- /.manual-text -->
							</div>
							<!-- /.manual-block -->
						...
						<div class="col-12 col-lg-3">
							<div class="manual-block">
								<div class="manual-block__img">
									<img src="<?php the_field('step_image_3', 2)?>" alt="">
								</div>
								<!-- /.manual-img -->
								<div class="manual-block__text">
									<?php the_field('step_text_3', 2)?>
									<div class="manual-block__text_order  show-order">
										<?php the_field('step_button_3', 2)?>
									</div>
								</div>
								<!-- /.manual-text -->
							</div>
						...
						<div class="col-12 col-lg-3">
							<div class="manual-block manual-block_last">
								<div class="manual-block__img">
									<img src="<?php the_field('step_image_4', 2)?>" alt="">
								</div>
								<!-- /.manual-img -->
								<div class="manual-block__text">
									<?php the_field('step_text_field_4', 2)?>
								</div>
								<!-- /.manual-text -->
							</div>
							<!-- /.manual-block -->
		...
		<section class="section-slider delivery" id="delivery">
			<div class="section-title delivery-section-title">
				<h2>
					<?php the_field('delivery_header', 2)?>
				</h2>
			</div>
			<!-- /.section-title -->
			<div class="container">
				<div class="row">
					<div class="col-12 col-md-6 col-xl-3">
						<div class="delivery-block">
							<div class="delivery-block__img">
								<img src="<?php the_field('delivery_icon_1', 2)?>" alt="">
							</div>
							<!-- /.delivery-block__img -->
							<div class="delivery-block__text">
								<?php the_field('delivery_text_1', 2)?>
							</div>
					...
					<div class="col-12 col-md-6 col-xl-3">
						<div class="delivery-block">
							<div class="delivery-block__img">
								<img src="<?php the_field('delivery_icon_2', 2)?>" alt="">
							</div>
							<!-- /.delivery-block__img -->
							<div class="delivery-block__text">
								<?php the_field('delivery_text_2', 2)?>
							</div>
							<!-- /.delivery-block__text -->
						</div>
						<!-- /.delivery-block -->
					...
					<div class="col-12 col-md-6 col-xl-3">
						<div class="delivery-block delivery-block_last1">
							<div class="delivery-block__img">
								<img src="<?php the_field('delivery_icon_3', 2)?>" alt="">
							</div>
							<!-- /.delivery-block__img -->
							<div class="delivery-block__text">
								<?php the_field('delivery_text_3', 2)?>
							</div>
							<!-- /.delivery-block__text -->
						</div>
						<!-- /.delivery-block -->
					...
					<div class="col-12 col-md-6 col-xl-3">
						<div class="delivery-block delivery-block_last2">
							<div class="delivery-block__img">
								<img src="<?php the_field('delivery_icon_4', 2)?>" alt="">
							</div>
							<!-- /.delivery-block__img -->
							<div class="delivery-block__text">
								<?php the_field('delivery_text_4', 2)?>
							</div>
							<!-- /.delivery-block__text -->
						</div>
						<!-- /.delivery-block -->
				...
				<div class="container">
					<div class="row justify-content-center">
						<div class="col-12 col-md-3">
							<div class="contacts-block">
								<div class="contacts-block__img">
									<img src="<?php	echo get_field('contacts_icon_1', 2)['url'];?>" alt="<?php echo get_field('contacts_icon_1', 2)['alt']?>">
								</div>
								<!-- /.contacts-block__img -->
								<div class="contacts-block__text">
									<a href="mailto:<?php the_field('contact_1', 2)?>"><?php the_field('contact_1', 2)?></a>
								</div>
						...
						<div class="col-12 col-md-3">
							<div class="contacts-block">
								<div class="contacts-block__img">
									<img src="<?php the_field('contacts_icon_2', 2)?>" alt="">
								</div>
								<!-- /.contacts-block__img -->
								<div class="contacts-block__text">
									<a href="tel:<?php the_field('contact_2', 2)?>"><?php the_field('contact_2', 2)?></a>
								</div>
								<!-- /.contacts-block__text -->
							</div>
							<!-- /.contacts-block -->
						...
						<div class="col-12 col-md-3">
							<div class="contacts-block contacts-block_last">
								<div class="contacts-block__img">
									<img src="<?php the_field('contacts_icon_3', 2)?>" alt="">
								</div>
								<!-- /.contacts-block__img -->
								<div class="contacts-block__text">
									<?php the_field('contact_3', 2)?>
								</div>
								<!-- /.contacts-block__text -->
							</div>
							<!-- /.contacts-block -->
